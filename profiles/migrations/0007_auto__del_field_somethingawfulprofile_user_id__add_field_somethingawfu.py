...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SomethingAwfulProfile.user_id'
        db.delete_column(u'profiles_somethingawfulprofile', 'user_id')

        # Adding field 'SomethingAwfulProfile.userid'
        db.add_column(u'profiles_somethingawfulprofile', 'userid',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SomethingAwfulProfile.user_id'
        db.add_column(u'profiles_somethingawfulprofile', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'SomethingAwfulProfile.userid'
        db.delete_column(u'profiles_somethingawfulprofile', 'userid')
