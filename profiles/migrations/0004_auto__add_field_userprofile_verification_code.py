...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_userprofile', 'verification_code',
                      self.gf('django.db.models.fields.TextField')(default='randomcode'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.verification_code'
        db.delete_column(u'profiles_userprofile', 'verification_code')
