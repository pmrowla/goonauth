...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NintendoProfile.username'
        db.delete_column(u'profiles_nintendoprofile', 'username')


    def backwards(self, orm):
        # Adding field 'NintendoProfile.username'
        db.add_column(u'profiles_nintendoprofile', 'username',
