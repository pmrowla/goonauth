...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OAuthApplication.website'
        db.add_column(u'profiles_oauthapplication', 'website',
                      self.gf('django.db.models.fields.URLField')(default='http://google.com/', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OAuthApplication.website'
        db.delete_column(u'profiles_oauthapplication', 'website')
    ...
    models = {
        ...
        u'oauth2_provider.application': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "u'mU;zkeBeWRhEMJODOK.m@=SDVM56;ZonJ@5UXw?R'", 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'aFFM1bxai;=uIN0V5Dl_ukv.YVNZd8X=2ET1Y=F7oFX@TT;geuuPb6Asq8VBI0JJTQ_7z8Jv;kYg79T1oy9rl7f0qhv3n?:i3c1wvToyfWGMqFtA3.2M=akyyeLT0HG@'", 'max_length': '255', 'blank': 'True'}),
