...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.leageoflegends'
        db.delete_column(u'profiles_userprofile', 'leageoflegends_id')

        # Adding field 'UserProfile.leagueoflegends'
        db.add_column(u'profiles_userprofile', 'leagueoflegends',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.LeagueOfLegendsProfile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.leageoflegends'
        db.add_column(u'profiles_userprofile', 'leageoflegends',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.LeagueOfLegendsProfile'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.leagueoflegends'
        db.delete_column(u'profiles_userprofile', 'leagueoflegends_id')
