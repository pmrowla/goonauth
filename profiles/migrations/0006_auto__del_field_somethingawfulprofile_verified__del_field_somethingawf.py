...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SomethingAwfulProfile.verified'
        db.delete_column(u'profiles_somethingawfulprofile', 'verified')

        # Deleting field 'SomethingAwfulProfile.avatar'
        db.delete_column(u'profiles_somethingawfulprofile', 'avatar')

        # Adding field 'SomethingAwfulProfile.url'
        db.add_column(u'profiles_somethingawfulprofile', 'url',
                      self.gf('django.db.models.fields.URLField')(default='http://forums.somethingawful.com/member.php?action=getinfo&userid=15053', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SomethingAwfulProfile.verified'
        db.add_column(u'profiles_somethingawfulprofile', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SomethingAwfulProfile.avatar'
        db.add_column(u'profiles_somethingawfulprofile', 'avatar',
                      self.gf('django.db.models.fields.URLField')(default='Deprecated', max_length=200),
                      keep_default=False)

        # Deleting field 'SomethingAwfulProfile.url'
        db.delete_column(u'profiles_somethingawfulprofile', 'url')
